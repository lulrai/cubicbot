...
class CraftImageUtil {
    ...
    static File getCompleted(int numCards, List<BufferedImage> itemImages, List<BufferedImage> itemMult, List<String> names, String itemType, String fileName) throws IndexOutOfBoundsException {
