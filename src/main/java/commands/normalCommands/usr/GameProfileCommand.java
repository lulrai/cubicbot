...
//        em.setAuthor(u.getName() +"#"+ u.getDiscriminator(), null, event.getAuthor().getEffectiveAvatarUrl());
        String id = u.getId();
        ...
        if(qbee == null) {
            em.setDescription("No commands.information regarding the user's profile.");
        }
        else {
            ...
            if(qbee.getProfilePic() != null && !qbee.getProfilePic().isEmpty()) {
                try{
                    new URL(qbee.getProfilePic());
                    em.setThumbnail(qbee.getProfilePic());
            ...
            if(!hasInfo) em.setDescription("No commands.information regarding the user's profile.");
        }
        em.setFooter("Requested by: "+event.getAuthor().getName()+"#"+event.getAuthor().getDiscriminator()+"\n"+"You are responsible for what you put on your profile. Inappropriate profiles can be deleted.", event.getAuthor().getEffectiveAvatarUrl());
